...
Enter food name and available quantity

Provide ingredient information for safety

Specify pickup and expiry time

The system will:

✔ Automatically remove expired food listings from the website
✔ Display only safe and available food
✔ Include a rating system for donors and receivers
✔ Enable quick claiming and pickup
...
**Percentage of AI-generated code:** [Ately X%]
...
- HRIDYA SASHEENDRAN P V: [Specific contributions - e.g., Frontend development, API integration, etc.]
- BEEGUM FIZA S S: [Specific contributions - e.g., Backend development, Database design, etc.]
